...
export default function () {
  ...
  async function Load() {
    await axios
      .get("https://localhost:8081/api/TradesMan/specialities", {
        timeout: 5000,
        headers: {
  ...
  async function becomer(event: { preventDefault: () => void }) {
    ...
    try {
      await axios
        .post(
          "https://localhost:8081/api/User/createTradesManProfile",
          {
                ...
                <Row>
                  ...
                  <Col xs={5}>
                    <h4 className="Auth-form-title">
                      Specialities that can be added
                    </h4>
                    <Container>
                      <Row>
